    ...
    return (
        <div>
            <div className="ad-modal-container">
                ...
                <img className="ad-img2" src="https://cdn.mos.cms.futurecdn.net/Fg9Y97ZB9MBTZpdqMFW34V.jpg"></img>
                <div className="ad-evnt-create-box">
                    <div className=''>
                        <a href="/CreateEvent"><img className="ad-img" src="https://openclipart.org/image/2400px/svg_to_png/183568/close-button.png"></img></a>
